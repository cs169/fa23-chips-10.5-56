...
RSpec.describe Representative, type: :model do
  describe '.civic_api_to_representative_params' do
    ...
    context 'when the representative already exists' do
      before do
        create(:representative, ocdid: 'existing_ocdid', name: 'Existing Name', title: 'Existing Title')
      end
      ...
      it 'updates the existing representative' do
        Representative.civic_api_to_representative_params(rep_info)
        representative = Representative.find_by(ocdid: 'existing_ocdid')
        expect(representative.name).to eq(/* new name from rep_info */)
        expect(representative.title).to eq(/* new title from rep_info */)
      end
    end
  end
end
